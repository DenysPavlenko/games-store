  ...
  return (
    <div className={classes}>
      <div className="buy-product-left">
        <Typography component="h2" variant="h1" className="mb-0">
          {name}
        </Typography>
      </div>
      <div className="buy-product-right">
        {inCart ? (
          ...
          <>
            <Typography
              component="h5"
              className="mb-0 text-muted buy-product-price"
            >
              USD
              {price}
            </Typography>
            <div className="buy-product-button-group">
              <Button onClick={onButtonClick} btnLarge>
                Buy now
              </Button>
              <Button onClick={onCartClick} className="buy-product-cart">
                <CartIcon />
              </Button>
            </div>
          </>
