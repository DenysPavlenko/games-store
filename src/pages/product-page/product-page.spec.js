...
const dummyProps = {
  game: {
    ...
    data: {
      ...
      previews: ['https://test.jpg', 'https://test2.jpg'],
    },
    error: false,
    errorDetails: null,
  },
...
describe('ProductPage', () => {
  ...
  test('redirects to 404 page on 404 error', () => {
    const wrapper = setup({
      ...dummyProps,
      game: { ...dummyProps.game, errorDetails: { message: '404' } },
    });
  ...
  test('renders error indicator on error', () => {
    const wrapper = setup({
      ...dummyProps,
      game: { ...dummyProps.game, error: true },
    });
  ...
  test('renders placeholder indicator on loading', () => {
    const wrapper = setup({
      ...dummyProps,
      game: { ...dummyProps.game, loading: true },
    });
  ...
  test('adds item to cart on cart click', () => {
    ...
    const wrapper = setup({ ...dummyProps, addItemToCart: mockAddItemToCart });
  ...
  describe('ProductTableItem', () => {
    test('renders without errors', () => {
      const wrapper = setupTableItem({
        title: 'Genre',
        property: ['Action', 'Shooter'],
      });
      expect(wrapper).not.toBeNull();
    });
